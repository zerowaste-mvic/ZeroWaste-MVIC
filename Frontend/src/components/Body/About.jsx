...
import { colors, sectionHeadingStyle, btnPrimaryStyle, shadows } from '../../theme';
      ...
      <div className="container" style={{ maxWidth: '1180px' }}>
        <div className="row align-items-center g-5">
          <div className="col-lg-6">
            <div className="overflow-hidden" style={{ borderRadius: 20, aspectRatio: '1/1', boxShadow: shadows.lg }}>
              <img
          ...
          <div className="col-lg-6">
            ...
            <p style={{ fontSize: '1.05rem', color: colors.muted, marginBottom: '2rem', lineHeight: 1.75 }}>
              We are convinced that the gap between food waste and food need can be closed.
              ZeroWaste exists to help households track what they have, plan smarter meals,
              and share surplus with neighbours — turning good food into shared value instead of landfill.
            </p>
                ...
                <div key={v.title} className="col-sm-6">
                  <div className="d-flex gap-3 align-items-start">
                    <div
                      ...
                      style={{ width: 40, height: 40, background: '#eaf5ef', borderRadius: 10, color: colors.green }}
                    >
                      {v.icon}
                    </div>
                    <div>
                      <div style={{ fontSize: '0.95rem', fontWeight: 700, color: colors.charcoal, marginBottom: 4 }}>
                        {v.title}
                      </div>
                      <div style={{ fontSize: '0.85rem', color: colors.muted, lineHeight: 1.55 }}>
                        {v.text}
                      </div>
                    </div>
                  </div>
